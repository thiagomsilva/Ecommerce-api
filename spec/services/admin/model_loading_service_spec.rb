    ...
    context "when #call" do
        ...
        context "when params are present" do
            ...
            it "returns right :length following pagination" do
                service = described_class.new(Category.all, params) # described_class => Admin::ModelLoadingService
            ...
            it "returns records following search, order and pagination" do
                search_categories.sort! { |a, b| b[:name] <=> a[:name] } # b <=> a ordenação descedente
